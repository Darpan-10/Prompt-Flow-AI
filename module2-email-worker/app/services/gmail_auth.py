"""
Gmail OAuth2 Authentication — Service Account with Domain-Wide Delegation.

WHY SERVICE ACCOUNT:
  Enterprise Gmail (Google Workspace) disables basic IMAP auth.
  Service Account + DWD allows headless server-to-server auth
  with no browser login ever required.
